...
var require_color = __commonJS({
  "node_modules/color-js/color.js"(exports, module) {
    ...
    (function() {
      ...
      registerModel("RGB", {
         ...
         */
        blend: function(color2, alpha) {
          color2 = color2.toRGB();
          alpha = Math.min(Math.max(alpha, 0), 1);
          var rgb = this.clone();
          rgb.red = rgb.red * (1 - alpha) + color2.red * alpha;
          rgb.green = rgb.green * (1 - alpha) + color2.green * alpha;
          rgb.blue = rgb.blue * (1 - alpha) + color2.blue * alpha;
          rgb.alpha = rgb.alpha * (1 - alpha) + color2.alpha * alpha;
          return rgb;
        },
        ...
        _stringParsers: [
          ...
          function(css) {
            if (css.toLowerCase() !== "transparent")
              return;
            return transparent;
          }
        ],
        _fromCSS: function(css) {
          ...
          for (var i = 0, j = this._stringParsers.length; i < j; i++) {
            color2 = this._stringParsers[i](css);
            if (color2)
              return color2;
          }
        },
        ...
        toHSV: function() {
          ...
          if (delta == 0) {
            ...
            if (this.red == max) {
              hsv.hue = (this.green - this.blue) / delta;
            } else if (this.green == max) {
              hsv.hue = 2 + (this.blue - this.red) / delta;
            } else {
              hsv.hue = 4 + (this.red - this.green) / delta;
            }
            hsv.hue = (hsv.hue * 60 + 360) % 360;
          }
      ...
      registerModel("HSV", {
        ...
        toHSL: function() {
          ...
          hsl.hue = this.hue;
          var l = (2 - this.saturation) * this.value, s = this.saturation * this.value;
          if (l && 2 - l) {
            s /= l <= 1 ? l : 2 - l;
          }
          l /= 2;
      ...
      registerModel("HSL", {
        ...
        toHSV: function() {
          ...
          var hsv = factories.HSV();
          hsv.hue = this.hue;
          var l = 2 * this.lightness, s = this.saturation * (l <= 1 ? l : 2 - l);
          hsv.value = (l + s) / 2;
          hsv.saturation = 2 * s / (l + s) || 0;
          hsv.alpha = this.alpha;
          return hsv;
        },
        toRGB: function() {
...
//# sourceMappingURL=color-js.js.map
